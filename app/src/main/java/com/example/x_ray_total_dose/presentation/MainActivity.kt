...
class MainActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val abdomen = findViewById<EditText>(R.id.abdomen)
        val pelvis = findViewById<EditText>(R.id.pelvis)
        ...
        arrayEditText.add(0, head)
        arrayEditText.add(1, neck)
        arrayEditText.add(2, chest)
        arrayEditText.add(3, abdomen)
        arrayEditText.add(4, pelvis)
